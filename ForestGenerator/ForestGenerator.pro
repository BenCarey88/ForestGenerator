...
# note that for some reason the 'Libnoise' path must be above the
# plain 'include' path for linking to work on my laptop
INCLUDEPATH += $(HOME)/Users/Ben/Libnoise/include \
               include/noise \
               include \
               include/boost
